function runGame(studentName,studentNumber){
    ...
    console.log(this)
            ...
            this.add
                .text(16, 16, `Arrow keys to move\nPress "S" to show stats menu ${this.game.formInfo.name}`, {
                    font: "18px Arial",
                    fill: "#000000",
                    padding: {
                        x: 20,
            ...
            ourPhase2Menu.events.on('createAntenna', function () {
                if (this.maxAntennas > this.antennaContainerGroup.children.size) {
                    ...
                    this.physics.add.collider(this.antennaContainerGroup, antennaContainer, () => {
                        this.coverageScore = this.coverageScore <= 0.01? 0 :(this.coverageScore * .92).toFixed(2);
                        this.events.emit('updateScene2Menu', this.coverageScore, this.antennas.length);
                    }); 
    ...
    game.formInfo ={name:studentName,number:studentNumber};
